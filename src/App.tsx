...
function App() {
  ...
  return (
    <>
      ...
      <footer>
        <span className="footer-copy">© 2025 Kloddy. Master your AI, no matter who you are.</span>
        <div className="footer-links"><a href="#">Docs</a><a href="#">Changelog</a><a href="#">Privacy</a><a href="#">Terms</a>
        </div>
      </footer>
